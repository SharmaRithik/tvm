// Variant: dlight_transB
// Compiler-scheduled, transposed B layout
...
fn main_kernel(
  ...
  for (var var_1 : i32 = 0i; var_1 < 1i; var_1++) {
    ...
    for (var ax3_0 : i32 = 0i; ax3_0 < 128i; ax3_0++) {
      ...
      B_reindex_shared[((i32(threadIdx.y) * 32i) + (i32(threadIdx.x) * 4i))] = B[(((((i32(blockIdx.y) * 32768i) + (i32(threadIdx.y) * 4096i)) + ((i32(threadIdx.x)>>1u) * 1024i)) + (ax3_0 * 8i)) + ((i32(threadIdx.x) & 1i) * 4i))];
      B_reindex_shared[(((i32(threadIdx.y) * 32i) + (i32(threadIdx.x) * 4i)) + 1i)] = B[((((((i32(blockIdx.y) * 32768i) + (i32(threadIdx.y) * 4096i)) + ((i32(threadIdx.x)>>1u) * 1024i)) + (ax3_0 * 8i)) + ((i32(threadIdx.x) & 1i) * 4i)) + 1i)];
      B_reindex_shared[(((i32(threadIdx.y) * 32i) + (i32(threadIdx.x) * 4i)) + 2i)] = B[((((((i32(blockIdx.y) * 32768i) + (i32(threadIdx.y) * 4096i)) + ((i32(threadIdx.x)>>1u) * 1024i)) + (ax3_0 * 8i)) + ((i32(threadIdx.x) & 1i) * 4i)) + 2i)];
      B_reindex_shared[(((i32(threadIdx.y) * 32i) + (i32(threadIdx.x) * 4i)) + 3i)] = B[((((((i32(blockIdx.y) * 32768i) + (i32(threadIdx.y) * 4096i)) + ((i32(threadIdx.x)>>1u) * 1024i)) + (ax3_0 * 8i)) + ((i32(threadIdx.x) & 1i) * 4i)) + 3i)];
      workgroupBarrier();
